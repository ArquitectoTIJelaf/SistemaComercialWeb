    ...
    public class Cuadre
    {
        ...
        public static string WriteText(VentaRealizadaEntity venta, string TipoImpresion)
        {
            ...
            else if (venta.TipImpresora == 3)
            {
                ...
                texto.AppendLine("SON: " + venta.PrecioDes);
                texto.AppendLine(new string('-', 80));
                texto.AppendLine(("CODIGO: " + venta.CodigoX_FE).PadRight(39) + PadBoth("OP.INAFECTA", 25) + "S/".PadLeft(5) + venta.PrecioCan.ToString("F2", CultureInfo.InvariantCulture).PadLeft(10));
                texto.AppendLine("Autorizado mediante: ".PadRight(40) + PadBoth("OP. GRAVADA", 25) + "S/".PadLeft(5) + 0.ToString("F2", CultureInfo.InvariantCulture).PadLeft(10));
            ...
            else if (venta.TipImpresora == 4)
            {
                ...
                texto.AppendLine("SON: " + venta.PrecioDes);
                texto.AppendLine(new string('-', 70));
                texto.AppendLine(("CODIGO: " + venta.CodigoX_FE).PadRight(32) + PadBoth("OP.INAFECTA", 20) + "S/".PadLeft(5) + venta.PrecioCan.ToString("F2", CultureInfo.InvariantCulture).PadLeft(8));
                texto.AppendLine("Autorizado mediante: ".PadRight(32) + PadBoth("OP. GRAVADA", 20) + "S/".PadLeft(5) + 0.ToString("F2", CultureInfo.InvariantCulture).PadLeft(8));
                texto.AppendLine("N° XXXXX/Sunat ".PadRight(32) + PadBoth("I.G.V. 18%", 20) + "S/".PadLeft(5) + 0.ToString("F2", CultureInfo.InvariantCulture).PadLeft(8));
                texto.AppendLine("IMPORTE TOTAL".PadLeft(52) + "S/".PadLeft(5) + venta.PrecioCan.ToString("F2", CultureInfo.InvariantCulture).PadLeft(8));
                texto.AppendLine(new string('-', 70));
